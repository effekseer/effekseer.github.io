...
var extindex=ext_path.lastIndexOf(".");var ext=extindex>=0?ext_path.slice(extindex):"";if(ext==".png"||ext==".jpg"){(function(){var image=new Image();image.onload=function(){var converted_image=_convertPowerOfTwoImage(image);onload(converted_image);};image.onerror=function(){if(!(typeof onerror==="undefined"))onerror('not found',path);};image.crossOrigin="anonymous";image.src=path;})();}else{_loadBinFile(path,function(buffer){onload(buffer);},onerror);}};var loadingEffect=null;var ContextStates=function(){function ContextStates(gl){_classCallCheck(this,ContextStates);this.gl=gl;this.ext_vao=null;this.isWebGL2VAOEnabled=false;this.effekseer_vao=null;this.current_vao=null;this.current_vbo=null;this.current_ibo=null;this.ext_vao=gl.getExtension('OES_vertex_array_object');if(this.ext_vao!=null){this.effekseer_vao=this.ext_vao.createVertexArrayOES();}else if('createVertexArray'in this.gl){this.isWebGL2VAOEnabled=true;this.effekseer_vao=this.gl.createVertexArray();}}
_createClass(ContextStates,[{key:"save",value:function save(){this.current_vbo=this.gl.getParameter(this.gl.ARRAY_BUFFER_BINDING);this.current_ibo=this.gl.getParameter(this.gl.ELEMENT_ARRAY_BUFFER_BINDING);if(this.ext_vao!=null){this.current_vao=this.gl.getParameter(this.ext_vao.VERTEX_ARRAY_BINDING_OES);this.ext_vao.bindVertexArrayOES(this.effekseer_vao);}else if(this.isWebGL2VAOEnabled){this.current_vao=this.gl.getParameter(this.gl.VERTEX_ARRAY_BINDING);this.gl.bindVertexArray(this.effekseer_vao);}}},{key:"restore",value:function restore(){if(this.ext_vao!=null){this.ext_vao.bindVertexArrayOES(this.current_vao);}else if(this.isWebGL2VAOEnabled){this.gl.bindVertexArray(this.current_vao);}
