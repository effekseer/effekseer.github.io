...
`連続`の場合は生成時間を使用し、`トリガー`の場合は生成トリガーと生成数を使用します。
...
生成モードが`トリガー`の場合に、生成を行うためのトリガー番号を指定します。

### トリガーあたり生成数

生成モードが`トリガー`の場合に、トリガーが発火するたびに生成する数を指定します。
...
トリガー種別は`トリガー0-3`に加え、`親消滅時`や`親衝突時`を選択できます。
