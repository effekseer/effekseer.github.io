...
You can also load animated FBX (`.fbx`) files. The first animation in the FBX file is played, and it advances according to the parent particle's time. Particles are generated from the animated model surface.
