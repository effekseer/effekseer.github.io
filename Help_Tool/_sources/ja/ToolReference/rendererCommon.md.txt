...
HDRに対応した環境以外では、値を大きくすると色がおかしくなる可能性があります。
...
UVが0.0未満または1.0を超えたときに、テクスチャの外側をどのように参照するかを指定します。
`繰り返し`、`クランプ`、`ミラー`から選択できます。
...
パーティクルごとにUVを左右反転して表示する確率を指定します。
見た目にばらつきを持たせたいときに有効です。
