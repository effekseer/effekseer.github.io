...
リボンの長さに応じて画像を繰り返します。鎖のような反復パターンがある表現に適しています。
繰り返しの基準となる長さは`タイルの長さ`で指定します。

#### タイル(パーティクル毎)

各パーティクル区間ごとに画像を繰り返します。鎖のような反復パターンがある表現に適しています。
端だけを繰り返さない設定や、指定したループ領域だけを繰り返す設定も利用できます。
