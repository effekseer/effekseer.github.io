...
Specifies how the texture is sampled when the UV goes below 0.0 or above 1.0.
...
Specifies the probability of flipping the UV horizontally for each particle.
This is useful for adding variation to the appearance.
