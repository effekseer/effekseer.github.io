...
Each entry can specify a model file together with translation, rotation, and scale offsets.
The models registered here are used when previewing in the editor.
At runtime, external models are provided when the effect is played.
